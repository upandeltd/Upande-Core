...
from upande_core import anomalies, capability, delegation, privilege, settings
...
def findings() -> list[dict]:
	...
	behind each one and the suggested fix - is `upande_core.anomalies.overview`.
