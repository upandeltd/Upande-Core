...
from upande_core import dashboard, delegation
from upande_core.tests.test_delegation import ADMIN, IN_SCOPE, build_fixture
...
class TestDashboard(IntegrationTestCase):
	...
	def test_user_detail_refuses_a_target_outside_a_delegate_scope(self):
		from upande_core.tests.test_delegation import OUT_OF_SCOPE
