...
from upande_core import capability, delegation, requests
from upande_core.tests.fixtures import INNOCUOUS_DOCTYPE, ensure_user
from upande_core.tests.test_delegation import ALLOWED_PROFILE, OUT_OF_SCOPE, build_fixture
...
class TestSelfService(IntegrationTestCase):
	...
	def test_every_administrative_endpoint_refuses_them(self):
		from upande_core import api, dashboard
