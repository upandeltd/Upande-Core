...
"""Deny-only permission hooks bounding what a delegate can see, and the
apps-screen gate for IT Operations.
...
from upande_core import delegation, settings
...
def has_app_permission() -> bool:
	...
	This is the surviving version of two: the folded-in app had its own tile
	check, but that tile no longer exists, and this one already covers the
	delegate case it was written for.
	"""
